...
MODE="${MODE:-smoke}"
CONFIG="courses/course4_langchain_ecosystem/chapter3_agents/class2_react_agent/configs/default.yaml"

python "courses/course4_langchain_ecosystem/chapter3_agents/class2_react_agent/train.py" --config "${CONFIG}" mode="${MODE}"
