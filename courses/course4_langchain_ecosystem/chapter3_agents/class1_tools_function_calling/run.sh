...
MODE="${MODE:-smoke}"
CONFIG="courses/course4_langchain_ecosystem/chapter3_agents/class1_tools_function_calling/configs/default.yaml"

python "courses/course4_langchain_ecosystem/chapter3_agents/class1_tools_function_calling/train.py" --config "${CONFIG}" mode="${MODE}"
