...
MODE="${MODE:-smoke}"
CONFIG="courses/course4_langchain_ecosystem/chapter1_core/class3_structured_output/configs/default.yaml"

python "courses/course4_langchain_ecosystem/chapter1_core/class3_structured_output/train.py" --config "${CONFIG}" mode="${MODE}"
